...
const FP_FLAG = Buffer.from([0x40, //FP_FLAG_JSON
0x80 //FP_FLAG_MSGPACK
]);
const FP_MESSAGE_TYPE = Buffer.from([0x0, //FP_MT_ONEWAY
0x1, //FP_MT_TWOWAY
0x2 //FP_MT_ANSWER
]);
...
const CRYPTO_CURVES = ['secp256k1'];

const CRYPTO_ALGORITHM = ['aes-128-cfb', 'aes-256-cfb'];
